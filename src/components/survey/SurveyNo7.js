...
const SurveyNo7 = () => {
  ...
  const handleNext = () => {
    navigate('/survey8');  // Use the correct path for navigation
  };
    ...
    <div className="min-h-screen bg-pink-200 flex items-center justify-center p-5">
      <div className="relative flex flex-row items-center bg-white bg-opacity-40 rounded-2xl shadow-xl px-5 py-20 w-full max-w-3xl">
        ...
        <div className="flex flex-col w-3/4 pl-5"> 
          <h1 className="text-2xl font-bold text-red-600 mb-6 pr-5">Do you prefer virtual meetings, in-person interactions, or a combination of both for your buddy interactions?
</h1>
